...
public interface PaymentRepository extends JpaRepository<Payment_Detail, Long> {
	...
	List<Map<String,Object>> getPersonalDetailsByQuoteNo(String quoteNo);
